...
print("""
    ...
    __  _______  _   _______________________      _____ __  _______ 
   /  |/  / __ \/ | / / ___/_  __/ ____/ __ \    / ___//  |/  / __ )
  / /|_/ / / / /  |/ /\__ \ / / / __/ / /_/ /    \__ \/ /|_/ / __  |
 / /  / / /_/ / /|  /___/ // / / /___/ _, _/    ___/ / /  / / /_/ / 
/_/  /_/\____/_/ |_//____//_/ /_____/_/ |______/____/_/  /_/_____/  
                                         /_____/                    
""")
print (Fore.MAGENTA+"---------------------------------------")
print ("")
print (Fore.YELLOW+"TEAM : "+Fore.CYAN+"/// T.ME/MONSTER_SECURITY ///")
print ("")
print (Fore.MAGENTA+" CODING : "+Fore.GREEN+"</> MONSTER_hp </>")
print ("")
print (Fore.WHITE+" GitHub : "+Fore.YELLOW+">>> https://github.com/MONSTER-hp <<<")
print ("")
print ("")
#1--------------------------- SHAD --------------------------
...
def shad(phone):
    ...
    try:
        ...
        if "OK" in shadR.text:
                 print (Fore.GREEN+"[^]"+Fore.GREEN+"SHAD SEND >")
        else:
            print (Fore.RED+"[~]"+Fore.RED+"SHAD ERROR <")
    except:
        print (Fore.RED+"[~]"+Fore.RED+"SHAD ERROR <")
...
def gap(phone):
    ...
    try:
        ...
        if "OK" in gapR.text:
            print (Fore.GREEN+"[^]"+Fore.BLUE+"GAP SEND >")
        else:
           print (Fore.RED+"[~]"+Fore.RED+"GAP ERROR <")
    except:
        print (Fore.RED+"[~]"+Fore.RED+"GAP ERROR <")
...
def tap30(phone):
    ...
    try:
        ...
        if "OK" in tap30R.text:
             print (Fore.GREEN+"[^]"+Fore.CYAN+"TAP30 SEND >")
        else:
            print (Fore.RED+"[~]"+Fore.RED+"TAP30 ERROR <")
    except:
            print (Fore.RED+"[~]"+Fore.RED+"TAP30 ERROR <")
...
def emtiaz(phone):
    ...
    try:
        ...
        if "OK" in emR.text:
             print (Fore.GREEN+"[^]"+Fore.YELLOW+"EMTIAZ SEND >")
        else:
            print (Fore.RED+"[~]"+Fore.RED+"EMTIAZ ERROR <")
    except:
            print (Fore.RED+"[~]"+Fore.RED+"EMTIAZ ERROR <")
...
def divar(phone):
    ...
    try:
        ...
        if "SENT" in divarR.text:
              print (Fore.GREEN+"[^]"+Fore.MAGENTA+"DIVAR SEND >")
        else:
            print (Fore.RED+"[~]"+Fore.RED+"DIVAR ERROR <")
    except:
            print (Fore.RED+"[~]"+Fore.RED+"DIVAR ERROR <")
...
def torob(phone):
    ...
    try:
        ...
        if "sent" in torobR.text:
             print (Fore.GREEN+"[^]"+Fore.CYAN+"TOROB SEND >")
        else:
            print (Fore.RED+"[~]"+Fore.RED+"TOROB ERROR <")
    except:
            print (Fore.RED+"[~]"+Fore.RED+"TOROB ERROR <")
...
def bama(phone):
    ...
    try:
        ...
        if "0" in bamaR.text:
               print (Fore.GREEN+"[^]"+Fore.WHITE+"BAMA SEND >")
        else:
            print (Fore.RED+"[~]"+Fore.RED+"BAMA ERROR <")
    except:
            print (Fore.RED+"[~]"+Fore.RED+"BAMA ERROR <")
            
#----------------------------- OPEN API & PHONE TARGET ------------------------         

try:
    phone = str(input(Fore.RED+"Number Phone Target [ +98********* ] : "))
    while True:
        ...
        print(Fore.RED+"!!! ERROR SYSTEM YOUR !!!")
